...
class PromoCodeUsed extends Component {
  getChartData() {
    const logs = this.props.referralLog.logs;
    ...
    return (
      <div className="card">
        <div className="header">
          <h4>Referral Code : Used</h4>
          <p className="category">Referral codes used over last 7 days</p>
        </div>
        <div className="content">
          {this.props.referralLog ? (
            <ReactChartist
        ...
        {this.props.referralLog ? (
          <div className="weekly-updated">
            ...
            <strong>
              {new Date(this.props.referralLog.fetchedTS).getHours() +
                ":" +
                new Date(this.props.referralLog.fetchedTS).getMinutes()}
            </strong>{" "}
            Hours
            <div
              onClick={() => {
...
function mapsStateToProps({ referralLog }) {
  return { referralLog };
}
